...
content:
  -
    ...
    title: 'Fixing broken websites and getting you back online'
    content: |-
      If your website is slow, broken, or holding your business back, I can help. I specialise in fixing websites that are not performing the way they should and getting them back up and running as quickly as possible.

      With over 20 years of professional experience, I am a trusted and reliable web designer and developer who knows how to diagnose problems, fix them properly, and explain things clearly along the way.
    type: hero
    enabled: true
  -
    id: bsT9BA6CPzuw2KLriTkNT
    title: 'When your website becomes a problem'
    content: |-
      Many websites start out fine and slowly degrade over time. Common issues I help clients with include:

      - Slow websites that frustrate visitors and hurt conversions
      - Poor or under-performing SEO that makes your site hard to find
      - Broken WordPress sites, updates, or plugins
      - Websites that are difficult or risky to update
      - Designs that do not work properly on mobile devices
      - Layouts that break across browsers or screen sizes
    ...
    enabled: true
  -
    id: 5FDLgSgDPjL7N3RY28B-v
    title: 'WordPress problems fixed properly'
    content: |-
    ...
    enabled: true
  -
    id: dprcB_v-64bE8YJEUBlwg
    title: 'Faster sites and better SEO'
    content: |-
  ...
  -
    ...
    enabled: true
  -
    id: PEe9DxQ8tPb7dUk2OaxQM
    title: 'Fast, fair, and reliable help'
    content: |-
