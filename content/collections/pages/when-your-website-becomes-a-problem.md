---
id: 975ea603-bee3-4ead-9a29-032fff190732
blueprint: page
...
updated_at: 1771817946
content:
  -
    id: DxA3Bh4spN8blHKN8cxKC
    title: 'When your website becomes a problem'
    content: |-
    ...
    enabled: true
  -
    id: LvWcZQxpsE8Hzu0HRRc0W
    title: 'Slow websites that cost you enquiries'
    content: |-
      ...
      - Excessive or poorly built plugins
      - Bloated themes
      - Inefficient database queries
      - Years of small changes layered on top of each other
    ...
    enabled: true
  -
    id: uwKSpXkbseMiLzbuS9hLm
    title: 'Poor or under-performing SEO'
    content: |-
      ...
      - Technical errors that stop search engines indexing properly
    ...
    enabled: true
  -
    id: 03YThYBL0bR8MwiN44b-0
    title: 'Broken WordPress sites, updates, and plugins'
    content: |-
      WordPress is powerful, but it can become fragile if it is not maintained properly.

      Common scenarios include:

      - A plugin update that brings down the site    
      - A theme conflict after a core update
      - PHP version changes breaking older functionality
    ...
    enabled: true
  -
    id: 3QbFGXbpkAq2_Xmp1Cne_
    title: 'Websites that feel risky to update'
    content: |-
      ...
      - Backed up properly    
      - Able to be updated safely
      - Structured clearly enough that changes are predictable
      - Supported by a recovery plan if something does go wrong
    ...
    enabled: true
  -
    id: CEfO4KQhk_iZSq3QKECqn
    title: "Designs that don't work on mobile"
    content: |-
    ...
    enabled: true
  -
    id: Q6dTu69M1bmCxDmyasZTd
    title: 'Layouts that break across browsers or screen sizes'
    content: |-
  ...
  -
    ...
    enabled: true
  -
    id: e3tEZrerNkscP3UzBfohs
    content: |-
      ## If your website feels fragile, that is a signal
